...
def load_math_element(mathElement):
	yield oMath2Latex(mathElement)

def load_math_paragraph_element(mathParagraphElement):
	for mathElement in mathParagraphElement.findall(OMML_NS + 'oMath'):
		return load_math_element(mathElement)
